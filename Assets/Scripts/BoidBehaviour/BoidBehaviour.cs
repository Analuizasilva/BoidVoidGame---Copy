...
namespace Assets.Scripts.BoidBehaviour
{
    public class BoidBehaviour : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            var boids = boidColliders.Select(o => o.GetComponent<BoidBehaviour>()).ToList();
            boids.Remove(this);
        ...
        private void Flock(IEnumerable<BoidBehaviour> boids)
        {
        ...
        private Vector2 Alignment(IEnumerable<BoidBehaviour> boids)
        {
        ...
        private Vector2 Cohesion(IEnumerable<BoidBehaviour> boids)
        {
        ...
        private Vector2 Separation(IEnumerable<BoidBehaviour> boids)
        {
        ...
        private float DistanceTo(BoidBehaviour boid)
        {
        ...
        private void WrapAround()
        {
            ...
            if (Position.y < -7) Position = new Vector2(Position.x, 7);
            if (Position.x > 9) Position = new Vector2(-9, Position.y);
            if (Position.y > 7) Position = new Vector2(Position.x, -7);
        }
    }
